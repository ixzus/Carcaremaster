...
public class Constant {
	...
	public static final String NEW_QUESTION_ACTION = "roster.newquestion";
	public static final String NEW_APPOINTMENT = "roster.newappointment";
	/**
	 * 我的消息
	 */
	public static final String MY_NEWS = "my.news";
	public static final String MY_NEWS_DATE = "my.news.date";
	public static final String MY_NEWS_TXT = "imtext";//新的文字回复
	public static final String MY_NEWS_AUDIO = "imaudio";//新的语音回复
	public static final String MY_NEWS_IMG = "imimage";//新的图片回复
	public static final String MY_NEWS_QUESTION = "immulti";//抢单
	public static final String MY_NEWS_QUESTION_AT = "imchat";//@我
	public static final String MY_NEWS_APPOINTMENT = "imorder";//@我
	/**
	 * 服务器的配置
	 */
