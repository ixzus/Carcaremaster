...
public class ModifyPhoneFragment extends Fragment implements OnClickListener {
    ...
    private void initView(View view) {
        llmain = (LinearLayout) view.findViewById(R.id.ll_frag_acc_con);
        ...
        switch (v.getId()) {
            case R.id.btn_contact_certain:
                ...
                if (et1.getText() == null || et2.getText() == null || et3.getText() == null || newp.equals("") || newp2.equals("") || captche.equals("")) {
                    ...
                    CommonUtil.showSnack(llmain, "手机号码格式不对");
                } else if (newp.equals(txt.getText().toString().trim())) {
                    CommonUtil.showSnack(llmain, "新号码不能和旧号码相同");
            ...
            case R.id.btn_captche:
                ...
                if (newp == null || newp.equals("")) {
                    CommonUtil.showSnack(llmain, "请输入新手机号码");
    ...
    private void postData(String num, String captche) {
        ...
        map.put("id", id);
        map.put("mobile", num);
        TaskExecutor.Execute(new DataRunnable(getActivity(), "/Artificer/updateMobile", mHandler, map));
    }
        ...
        private void doAction(Activity activity, int what, String json) {
            ...
            if (!CommonUtil.isEmpty(json)) {
                try {
                    ...
                    if (error.equals("0")) {
                        CommonUtil.showSnack(llmain, "联系方式修改成功，请牢记哒");
                        getActivity()
                                .getSharedPreferences(Config.USERINFO, 0)
                                .edit()
                                .putString(Config.USERNAME, et1.getText().toString().trim())
                                .commit();// 先将这个iD存储起来
