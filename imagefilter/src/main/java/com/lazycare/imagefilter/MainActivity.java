package com.lazycare.imagefilter;
...
import com.lazycare.imagefilter.util.BitmapFilter;
...
public class MainActivity extends Activity implements OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        originalBitmap = BitmapFactory.decodeResource(this.getResources(), R.mipmap.huishu);
	...
	public void onClick(View v) {
    	...
    	case R.id.compose_btn:
    		Bitmap b2 = BitmapFactory.decodeResource(getResources(), R.mipmap.huishu3);
